...
module('Integration | Component | chats/chat/-components/route-view/main-content', function (hooks) {
  ...
  test('should show <MessageList />', async function (assert) {
    ...
    // Act
    await render(hbs`{{chats/chat/-components/route-view/main-content chat=this.chat permissionState=this.permissionState}}`);
