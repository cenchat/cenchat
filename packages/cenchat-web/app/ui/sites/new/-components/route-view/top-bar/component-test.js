...
module('Integration | Component | sites/new/-components/route-view/top-bar', function (hooks) {
  ...
  test('should enable save button when info is dirty', async function (assert) {
    ...
    // Act
    await render(hbs`{{sites/new/-components/route-view/top-bar hasPendingSiteChanges=this.hasPendingSiteChanges}}`);
